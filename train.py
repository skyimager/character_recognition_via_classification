...
print("working dir is: {}".format(os.getcwd()))
...
if __name__ == "__main__":
    ...
    train_generator = DataGenerator(base_path, file_paths =X_train, labels =y_train, 
                                    ...
                                    dim=(size,size), n_channels=chs, n_classes= classes, 
                                    shuffle=True)

    validation_generator = DataGenerator(base_path, file_paths =X_val, labels =y_val, 
                                         preprocess = preprocess, batch_size = batch_size,
                                         dim=(size,size), n_channels= chs, n_classes= classes, 
                                         shuffle=True)
